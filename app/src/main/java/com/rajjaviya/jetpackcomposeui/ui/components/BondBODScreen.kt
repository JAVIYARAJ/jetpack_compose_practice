    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Scaffold(
            ...
            Column(
                ...
                // Subtitle
                Text(
                    text = "It won't be visible to anyone else",
                ...
                if (!showDatePicker) {
                    TextButton(onClick = {
                        ...
                        Text(
                            text = selectedDateText.ifEmpty { "MM DD YYYY" },
                            style = MaterialTheme.typography.bodyMedium,
                            fontWeight = FontWeight.W300,
                            fontSize = 24.sp,
                            textAlign = TextAlign.Center,
        ...
        Box(
            ...
            val fabColor by animateColorAsState(
                targetValue = if (selectedDateText.isNotEmpty()) Color.Black else Color(0xFFCCCCCC),
